...
public class PremierLeagueManager implements LeagueManager {
    ...
    ArrayList< Match > footballMatch = new ArrayList<>();
    ...
    public void displayTable() {
        ...
        Comparator<FootballClub> pointSort = Comparator.comparing(FootballClub::getTotalPoints)
   ...
   public void addMatch(){
       ...
       System.out.println("Enter the teams that played ");
       System.out.println("Team one(By Number): ");
       int t1 = input.nextInt() - 1;
       System.out.println("Goals scored : ");
       int t1Goals = input.nextInt();
       System.out.println("Team Two(By Number): ");
